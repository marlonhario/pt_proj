    ...
    <Card>
      <CardBody>
        <div className="email-confirmation">
          ...
          <p className="email-confirmation__sub">Thank you for choosing Prospertogether</p>
          <ButtonToolbar className="email-confirmation__buttons">
            <Link className="btn btn-primary" to="/pages">Go to dashboard</Link>
            <Link className="btn btn-primary" to="/pages">Go to profile</Link>
          </ButtonToolbar>
        </div>
      </CardBody>
    </Card>
